...
/// <summary>
///     Example demonstrating how to use the GameEventBus system
...
public partial class EventBusUsageExample : Node
{
    ...
    {
        // Get the GameEventBus from the ServiceContainer
    ...
    private void PublishExampleEvents()
    {
        ...
        var gameCreatedEvent = new GameCreatedEvent(Guid.NewGuid(), "PlayerName");
        ...
        var dayEvent = new DayAdvancedEvent(42);
